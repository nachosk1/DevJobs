<form action="" class="md:w-1/2 space-y-5 px-4" wire:submit.prevent='editVacant'>
    <div>
    ...
    <div>
        ...
        <x-text-input id="image" accept="image/*" class="block mt-1 w-full" type="file" wire:model="image_new" />
        <div class="my-5">
            ...
            <div class="my-5">
                @if ($image_new)
                    Image Nueva:
                    <img src="{{ $image_new->temporaryUrl() }}" alt="imagen prev">
                @endif
            </div>
